...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#28ca9d' : 'black', //#253b5a #ff007a
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#28ca9d',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#28ca9d',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#28ca9d',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #253b5a 0%, #fff 0%)`,
})
